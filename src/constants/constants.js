...
export const EXECUTEDACTION = {
  create: {id: 1, label: 'Create'},
  delete: {id: 2, label: 'Delete'},
  update: {id: 3, label: 'Update'},
  eventOpened: {id: 4, label: 'Event opened'},
  eventClosed: {id: 5, label: 'Event closed'},
  blockSlots:  {id: 6, label: 'Block slots'},
  queueCopy: {id: 7, label: 'Copy'},
  excel: {id: 8, label: 'Excel'},
  clinicRoster: {id: 9, label: 'Clinic Roster'},
...
export const PAGECHILDRENID = {
  queueEdit: {id: 1, label: 'Edit', adminPageId: 'queueAdmin'},
  queueRegister: {id: 2, label: 'Register', adminPageId: 'queue'},
  queueList: {id: 3, label: 'Queue', adminPageId: 'queue'},
  queueContact: {id: 4, label: 'Contact', adminPageId: 'queue'},
  waitListEdit: {id: 5, label: 'WaitList Edit', adminPageId: 'waitListAdmin'},
  waitListOptions: {id: 6, label: 'WaitList Options', adminPageId: 'waitList'},
  waitListView: {id: 7, label: 'WaitList View', adminPageId: 'waitList'},
  waitListFollow: {id: 8, label: 'WaitList Follow', adminPageId: 'waitList'},
  waitListfollowupItem: {id: 9, label: 'WaitList Follow item', adminPageId: 'waitList'},
